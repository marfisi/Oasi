...
@NamedQueries(
	{@NamedQuery(
		name = "AsAnma20f.findAll",
		query = "SELECT o FROM Anma20f o order by o.m2cod asc"
	), @NamedQuery(
		name = "AsAnma20f.findByM2cod",
		query = "SELECT o FROM Anma20f o WHERE o.m2cod = :m2cod"
	), @NamedQuery(
		name = "AsAnma20f.findByM2oas",
		query = "SELECT o FROM Anma20f o WHERE o.m2oas = :m2oas order by o.m2cod asc"
	)
	}
)
