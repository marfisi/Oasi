...
@Entity(name = "Oaanm0f")
@NamedQueries({
	@NamedQuery(name = "AsOaanm0f.findAll", query = "SELECT a FROM Oaanm0f a"),
	@NamedQuery(name = "AsOaanm0f.findByMcoda", query = "SELECT a FROM Oaanm0f a WHERE a.mcoda = :mcoda"),
	@NamedQuery(name = "AsOaanm0f.svuota", query = "DELETE FROM Oaanm0f a WHERE a.mcoda != ''")
})
