...
*/
@Entity(
	name = "OA_AnagSottofam"
)
@NamedQueries(
	{@NamedQuery(
		name = "MsvOA_AnagSottofam.findAll",
		query = "SELECT o FROM OA_AnagSottofam o WHERE o.sotCodice != '' order by o.sotCodice asc"
	), @NamedQuery(
		name = "MsvOA_AnagSottofam.findBySotCodice",
		query = "SELECT o FROM OA_AnagSottofam o WHERE o.sotCodice = :sotCodice"
	), @NamedQuery(
		name = "MsvOA_AnagSottofam.findBySotFamiglia",
		query = "SELECT o FROM OA_AnagSottofam o WHERE o.sotFamiglia = :sotFamiglia"
	)
	}
)
