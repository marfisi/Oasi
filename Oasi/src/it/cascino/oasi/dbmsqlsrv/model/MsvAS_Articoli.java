...
@NamedQueries(
	{@NamedQuery(
		name = "MsvAS_Articoli.findAll",
		query = "SELECT o FROM AS_Articoli o WHERE o.codArticolo != '' order by o.codArticolo asc"
	), @NamedQuery(
		name = "MsvAS_Articoli.findByCodArticolo",
		query = "SELECT o FROM AS_Articoli o WHERE o.codArticolo = :codArticolo"
	), @NamedQuery(
		name = "MsvAS_Articoli.svuota",
		query = "DELETE FROM AS_Articoli o WHERE o.codArticolo != ''"
	)
	}
)
