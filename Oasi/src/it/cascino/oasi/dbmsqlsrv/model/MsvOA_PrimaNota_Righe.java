...
*/
@Entity(
	name = "OA_PrimaNota_Righe"
)
@NamedQueries(
	{@NamedQuery(
		name = "MsvOA_PrimaNota_Righe.findAll",
		query = "SELECT o FROM OA_PrimaNota_Righe o WHERE substring(o.tipoOperazione, 1, 1) != '*' and o.tipoOperazione != 'DEL' order by o.id.nReg,  o.id.nRiga"
	), @NamedQuery(
		name = "MsvOA_PrimaNota_Righe.findById",
		query = "SELECT o FROM OA_PrimaNota_Righe o WHERE substring(o.tipoOperazione, 1, 1) != '*' and o.tipoOperazione != 'DEL' and o.id.nReg = :nReg and o.id.nRiga = :nRiga"
	), @NamedQuery(
		name = "MsvOA_PrimaNota_Righe.findByNReg",
		query = "SELECT o FROM OA_PrimaNota_Righe o WHERE substring(o.tipoOperazione, 1, 1) != '*' and o.tipoOperazione != 'DEL' and o.id.nReg = :nReg order by o.id.nRiga"
	), @NamedQuery(
		name = "MsvOA_PrimaNota_Righe.findByNRegElaborate",
		query = "SELECT o FROM OA_PrimaNota_Righe o WHERE substring(o.tipoOperazione, 1, 1) = '*' and o.tipoOperazione != 'DEL' and o.id.nReg = :nReg order by o.id.nRiga"
	)
	}
)
