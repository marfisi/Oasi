...
@NamedQueries(
	{@NamedQuery(
		name = "MsvOA_AnagLivelli.findAll",
		query = "SELECT o FROM OA_AnagLivelli o WHERE o.lvmCodice != '' order by o.lvmCodice asc"
	), @NamedQuery(
		name = "MsvOA_AnagLivelli.findByLvmCodice",
		query = "SELECT o FROM OA_AnagLivelli o WHERE o.lvmCodice = :lvmCodice"
	), @NamedQuery(
		name = "MsvOA_AnagLivelli.findByCodiceCascino",
		query = "SELECT o FROM OA_AnagLivelli o WHERE o.codiceCascino = :codiceCascino"
	)
	}
)
