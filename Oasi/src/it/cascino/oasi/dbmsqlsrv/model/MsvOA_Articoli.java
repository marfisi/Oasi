...
@NamedQueries(
	{@NamedQuery(
		name = "MsvOA_Articoli.findAll",
		query = "SELECT o FROM OA_Articoli o WHERE substring(o.tipoOperazione, 1, 1) != '*' and o.tipoOperazione != 'DEL' and o.codBreveOasi != '' order by o.codBreveOasi asc"
	), @NamedQuery(
		name = "MsvOA_Articoli.findByCodBreveOasi",
		query = "SELECT o FROM OA_Articoli o WHERE substring(o.tipoOperazione, 1, 1) != '*' and o.tipoOperazione != 'DEL' and o.codBreveOasi = :codBreveOasi"
	), @NamedQuery(
		name = "MsvOA_Articoli.findByCodArticoloCascino",
		query = "SELECT o FROM OA_Articoli o WHERE substring(o.tipoOperazione, 1, 1) != '*' and o.tipoOperazione != 'DEL' and o.codArticoloCascino = :codArticoloCascino"
	), @NamedQuery(
		name = "MsvOA_Articoli.svuota",
		query = "DELETE FROM OA_Articoli o WHERE substring(o.tipoOperazione, 1, 1) = '*' and o.tipoOperazione != 'DEL' and o.codBreveOasi != ''"
	)
	}
)
