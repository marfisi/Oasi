...
//	private Logger log;
	...
	public MsvOA_MovimentiRighe(MsvOA_MovimentiRighePKey id, String codArticoloOasi, String codLungoOasi, String codArticoloCascino, BigDecimal qta, BigDecimal prezzoNetto, BigDecimal prezzoNettoIvaTes, String codIvaRiga, BigDecimal costo, String codOperatore, String tipoOperazione){
		super();
		this.id = id;
