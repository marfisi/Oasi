...
@NamedQueries(
	{@NamedQuery(
		name = "MsvAS_Fornitori.findAll",
		query = "SELECT o FROM AS_Fornitori o WHERE o.codice != '' order by o.codice asc"
	), @NamedQuery(
		name = "MsvAS_Fornitori.findByCodice",
		query = "SELECT o FROM AS_Fornitori o WHERE o.codice = :codice"
	), @NamedQuery(
		name = "MsvAS_Fornitori.svuota",
		query = "DELETE FROM AS_Fornitori o WHERE o.codice != ''"
	)
	}
)
