...
/**
* The persistent class for the AS_Clienti database table.
* 
*/
@Entity(name="AS_Clienti")
@NamedQueries({
	@NamedQuery(name = "MsvAS_Clienti.findAll", query = "SELECT a FROM AS_Clienti a WHERE a.codice != '' order by a.codice asc"),
	@NamedQuery(name = "MsvAS_Clienti.findByCodice", query = "SELECT a FROM AS_Clienti a WHERE a.codice = :codice"),
	@NamedQuery(name = "MsvAS_Clienti.svuota", query = "DELETE FROM AS_Clienti a WHERE a.codice != ''")
})
public class MsvAS_Clienti implements Serializable{
...
//	private Logger log;
	...
	public boolean equals(Object obj){
		if(obj instanceof MsvAS_Clienti){
			if(this.codice == ((MsvAS_Clienti)obj).codice){
				return true;
			}else{
				return false;
			}
