...
@NamedQueries(
	{@NamedQuery(
		name = "MsvAS_Clienti.findAll",
		query = "SELECT o FROM AS_Clienti o WHERE o.codice != '' order by o.codice asc"
	), @NamedQuery(
		name = "MsvAS_Clienti.findByCodice",
		query = "SELECT o FROM AS_Clienti o WHERE o.codice = :codice"
	), @NamedQuery(
		name = "MsvAS_Clienti.svuota",
		query = "DELETE FROM AS_Clienti o WHERE o.codice != ''"
	)
	}
)
